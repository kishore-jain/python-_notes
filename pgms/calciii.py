...
class MyWindow:
    def __init__(self, win):
        # label intro
        self.lbl1=Label(win, text='First number',bg='cyan',fg='orange')
        self.lbl2=Label(win, text='Second number',bg='cyan',fg='orange')
        self.lbl3=Label(win, text='Result',bg='orange',fg='cyan')
...
url = ImageTk.PhotoImage(Image.open(r"C:\Users\ELCOT\Downloads\wepik-export-20240105164244Ox59 (1).jpeg"))
p1 = Label(win, image = url,height=1000,width=1550)
